...
<form method="post" action="my_profil_register?id=<?=$_SESSION['user']['id_user']?>" class="w-50 mx-auto">
    <div class="row g-3">
        ...
        <div class="form-group mb-2">
            <label for="profil-picture" class="form-label">Modifier votre ancienne photo de profil :&nbsp;</label>
            <span name="picture-profil"><?=!empty($_SESSION['user']['pp']) ? $_SESSION['user']['pp'] : "";?></span><br>
